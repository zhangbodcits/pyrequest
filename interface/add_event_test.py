...
class AddEventTest(unittest.TestCase):
    ...
    def test_add_event_eid_exist(self):
        '''id已经存在'''
        payload = {'eid': 1, 'name': '1加4发布会', 'limit': '2000', 'address': '芮城县花园小区',
    ...
    def test_add_event_name_exist(self):
        '''发布会名称已经存在'''
        payload = {'eid': 11, 'name': '华为P51发布会', 'limit': '2000', 'address': '芮城县花园小区',
                   'start_time': '2020-08-01 12:00:00', 'create_time': '2020-08-01 12:00:00'}
        r = requests.post(self.base_url, data=payload)
        self.result = r.json()
    ...
    def test_add_event_success(self):
        '''添加成功'''
        payload = {'eid': 12, 'name': '1加5发布会', 'limit': '2000', 'address': '芮城县花园小区',
